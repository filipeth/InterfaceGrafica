...
public class StalkSurfaceBelowRing extends JFrame {
	...
	public   StalkSurfaceBelowRing(String i[]) {
		this.i = i;
		...
		JLabel lblCapshap = new JLabel("stalk-surface-below-ring");
		...
		btnProximo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				System.out.println("escolheu a opcao " + i[12] );
				new StalkColoAboveRing(i).setVisible(true);			}
		});
