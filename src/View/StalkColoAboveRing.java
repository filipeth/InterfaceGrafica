...
public class StalkColoAboveRing extends JFrame {
	...
	public  StalkColoAboveRing(String i[]) {
		this.i = i;
		...
		JLabel lblCapshap = new JLabel("stalk-color-above-ring");
		...
		btnProximo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				System.out.println("escolheu a opcao " + i[13] );
				new StalkColoBelowRing(i).setVisible(true);			}
		});
