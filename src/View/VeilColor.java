...
public class VeilColor extends JFrame {
	...
	public  VeilColor(String i[]) {
		...
		JRadioButton rdbtnBuff = new JRadioButton("Orange");
		rdbtnBuff.setBounds(116, 137, 109, 23);
		contentPane.add(rdbtnBuff);
		
		JRadioButton rdbtnCinnamon = new JRadioButton("White");
		rdbtnCinnamon.setBounds(227, 137, 109, 23);
		contentPane.add(rdbtnCinnamon);
		
		JRadioButton rdbtnGray= new JRadioButton("Yellow");
		...
		JLabel lblCapshap = new JLabel("Veil Color");
		...
		btnProximo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				System.out.println("escolheu a opcao " + i[16] );
				new RingNumber(i).setVisible(true);			}
		});
